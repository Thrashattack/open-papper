 ...
 * @version     $Id: group_add.php,v 1.7 2007/12/11 15:46:32 roufneck Exp $
 */

/**
 * @admintitle  Add user group
 * @adminnav    0
...
function admin_group_add()
{
    ...
    switch($op) {
        ...
        case props_gettext("Save"):
            ...
            if (sql_num_rows(sql_query("SELECT * FROM props_users_groups WHERE group_name = '" . sql_escape_string($group_name) . "'"))) {
