 ...
 * @version     $Id: archives_prev_page.php,v 1.10 2007/11/13 13:10:23 roufneck Exp $
 */

/**
 * Returns previous page link
 *
 * @tag    {archives_prev_page}
 * @param  array  &$params  parameters
 * @return  string  generated html code
 */
function tag_archives_prev_page(&$params)
{
    $output = '';

    // If there are more results to be displayed, output a link
    if (props_getkey('archives.prev_page') !== NULL) {

        $urlargs = array(
            'search_string' => props_getkey('archives.search_string'),
            'cmd' => 'archives-search',
            'position' => (props_getkey('archives.prev_page')),
        ...
        $output = '<a href="' . genurl($urlargs) . '">' . props_gettext("Previous") . '</a>';
    }
